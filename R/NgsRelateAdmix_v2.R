                ...
                for(g12 in 0:1){
                  for(g21 in 0:1){
                    ...
                    for(g22 in 0:1){
                      ...
                      ppart<-Pa*Pr*P1*P2*PGL1*PGL2
                      ssum<-ssum+ppart
                    
                      if(pprint)

                      cat(count,"a:",a11,a12,a21,a22,"Z:",z1,z2,"G1:",g11,g12,"G2:",g21,g22,"Pa=",Pa,"Pr=",Pr,"PGL1=",PGL1[n],"PGL2=",PGL2[n],"sum=",ssum[n],"ppart=",ppart[n],"P1*P2=",P1[n]*P2[n],"\n")
                    }
                  }
                }
              }
            ...
            for(z2 in 0:1){ 
              ...
              for(geno1 in 0:2){
                for(geno2 in 0:2){
                  ...
                  #            ssum<-ssum+Pa*Pr
                  if(pprint)
                    cat(count,"a:",a11,a12,a21,a22,"z:",z1,z2,"G1",geno1,"G2",geno2,"mult",mult,"Pa=",Pa,"Pz=",Pz,"sum=",sum(ssum),"ppart=",sum(ppart),"P1*P2=",P1[n]*P2[n],"\n")
                }
              }
            }
          }
                    ...
                    for(g22 in 0:1){
                      ...
                      #    P1<- g11+(-1)^g11*f[,a11]
                       # else     #ind1 hap1                    #ind2 hap1
                        ...
                        if(pprint)
                          cat(count,"a:",a11,a12,a21,a22,"z:",z1,z2, "G1:",g11,g12, "G2:",g21,g22,"Pa=",Pa,"Pz=",Pz,"sum=",sum(ssum),"ppart=",sum(ppart),"P1*P2=",P1[n]*P2[n],"\n")
                    }
                  }
                }
              }
...
NgsAdmixRelateEM<-function(initZ,a1,a2,f,GL1,GL2,maxit,tol){
  ...
  par<-c(initZ,NA)
  flag<-0
  ppart<-doProb(initZ,a1,a2,f,like1,like2,pprint=F)
...
#####Simulate genotypes
#########################################
k2=c(0.2,0.05,0) ### 25%:  IBD 2 fra population 1
...
#####Maximum likelihood 
#########################################
NgsAdmixRelateML(initZ,a1,a2,f,like1,like2)
...
a1
sum(a1)
c(1-sum(k1)-sum(k2),sum(k1),sum(k2))
...
NgsAdmixRelateSquareEM(initZ,a1,a2,f,like1,like2,maxit,tol,pprint=F)
NgsAdmixRelateEM(initZ,a1,a2,f,like1,like2,maxit,tol)
...
NgsAdmixRelateEMoneStepOld(initZ,a1,a2,f,like1,like2)
NgsAdmixRelateEMoneStepOld_v2(initZ,a1,a2,f,like1,like2)
